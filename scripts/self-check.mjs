...
assert.match(lineChart, /plotly\.react/);
...
assert.match(uiComponents, /<ScientificTaskPanel/);
assert.match(uiComponents, /<ScientificAppShell/);
assert.match(uiComponents, /<ScientificStatusBar/);
assert.match(uiComponents, /Calculate I–V sweep/);
